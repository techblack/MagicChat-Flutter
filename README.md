...
- 消息：私聊、群聊、应用会话、话题、回复、转发、回应、选择消息、附件、移动端相册/相机图片、桌面文件拖放与截图、语音、Markdown、图表与系统事件
- 联系人：好友目录、好友申请、在线状态、公开群组和应用管理
- 项目：项目、任务、看板、月历、甘特图、评论、提醒、成员与群组授权
- 文档：Markdown 协作编辑、Yjs 富文档、在线协作者状态和文档目录树
- 客户端：多账户、主题切换、SQLite WAL 消息缓存、连接与运行诊断、会话高级检索、全局搜索、二维码、推送授权、通知提示音和隐私设置、跨平台版本检查
